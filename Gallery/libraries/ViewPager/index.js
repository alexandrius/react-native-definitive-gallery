...
export default class ViewPager extends PureComponent {
   ...
   createScroller() {
      return new Scroller(true, (dx, dy, scroller) => {
         if (dx === 0 && dy === 0 && scroller.isFinished()) {
            ...
            let offset =
               (curX - this.getScrollOffsetOfPage(position)) /
               (this.state.width + this.props.pageMargin);
            let fraction =
               (curX -
                  this.getScrollOffsetOfPage(position) -
   ...
   getScrollOffsetFromCurrentPage() {
      return (
         this.scroller.getCurrX() - this.getScrollOffsetOfPage(this.currentPage)
      );
   }
      ...
      return (
         ...
         >
            <FlatList
               ...
               ref={(ref) => (this.innerFlatList = ref)}
